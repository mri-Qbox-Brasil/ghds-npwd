...
export const Dock: React.FC<DockProps> = ({ apps }) => {
    ...
    return (
        <div style={{ position: 'absolute', bottom: '24px', left: '16px', right: '16px' }}>
            <div className="h-[88px] w-full rounded-[32px] backdrop-blur-3xl backdrop-saturate-[200%] bg-white/30 dark:bg-black/30 border border-white/10 dark:border-white/5 flex items-center justify-evenly px-2">
                {apps.map((app) => (
