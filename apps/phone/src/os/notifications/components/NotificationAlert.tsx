...
export const NotificationAlert = () => {
  ...
  return (
    <div className="absolute top-[20px] inset-x-0 z-[100] flex justify-center items-center pointer-events-none">
      <div
        className={`pointer-events-auto transition-all duration-300 ease-out transform ${currentAlert ? 'translate-y-0 opacity-100' : '-translate-y-[120%] opacity-0'
          }`}
      >
        {currentAlert && (
          <Flex
