...
export const NotificationAlert = () => {
  ...
  return (
    <div className="absolute top-2 inset-x-0 z-[999] flex justify-center items-start pointer-events-none">
      <div
        className={cn(
          ...
          >
            {currentAlert?.icon && (
              <div className="flex items-center justify-center py-3 pl-4">
                <div className="w-10 h-10 rounded-[10px] overflow-hidden bg-gradient-to-br from-neutral-100 to-neutral-200 dark:from-neutral-700 dark:to-neutral-800 flex items-center justify-center shadow-sm">
